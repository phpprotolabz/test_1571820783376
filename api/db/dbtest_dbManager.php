...
function getConnection() {
	...
	global $db_test_db_Url, $db_test_db_User, $db_test_db_Pass, $db_test_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_test_db_Url.";dbname=".$db_test_db_DbName, $db_test_db_User, $db_test_db_Pass);
